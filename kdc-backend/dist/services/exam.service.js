...
export const getExams = async (userId, userRole, filter) => {
    let query = {};
    if (userRole === 'student') {
...
export const getExamsById = async (id, userId, userRole) => {
...
export const updateExam = async (id, userId, data) => {
    ...
    if (data.duration !== undefined)
        returnVal.duration = data.duration;
    if (data.className !== undefined)
        returnVal.class = data.className;
